...
export class WorklogService {
  ...
  initReportParams(): Promise<ReportParams> {
    ...
    return this._http.get<ReportParams>(this._initParamsUrl, options)
                    .toPromise()
  ...
  getWorklogsList(params: ReportParams): Promise<Worklog[]> {
    ...
    return this._http.post<Response>(this._worklogsListUrl, body, options)
                    .toPromise()
  ...
  createWorklogInJira(params: {
    ...
    return this._http.post<Response>(this._updateJiraHoursUrl, body, options);
  }
  ...
  updateHoursInJira(params : any): Observable<Response> {
    ...
    return this._http.put<Response>(this._updateJiraHoursUrl, body, options);
  }
  ...
  createWorklogInCats(params: {
    ...
    return this._http.post<Response>(this._updateCatsHoursUrl, body, options);
  }
  ...
  updateHoursInCats(params : any): Observable<Response> {
    ...
    return this._http.put<Response>(this._updateCatsHoursUrl, body, options);
  }
  ...
  private extractWorklogs(res: Response): Promise<Worklog[]> {
    if (res.status < 200 || res.status >= 300) {
      throw new Error('Bad response status: ' + res.status);
    }
    return res.json()
      .then(o => Worklog.fromJsonArray(o.matches));
  }
