...
// import { MD_ICON_DIRECTIVES, MdIconRegistry } from '@angular/material/icon';
// import { MD_CARD_DIRECTIVES } from '@angular/material/card';
// import { MD_TOOLBAR_DIRECTIVES } from '@angular/material/toolbar';
// import { MD_INPUT_DIRECTIVES } from '@angular/material/input';
// import { MD_BUTTON_DIRECTIVES } from '@angular/material/button';
// import { MD_PROGRESS_BAR_DIRECTIVES } from '@angular/material/progress-bar';
// import { MD_PROGRESS_CIRCLE_DIRECTIVES } from '@angular/material/progress-spinner';
...
@Component({
    ...
    styleUrls: ['worklogs-list.component.css'],
...
export class WorklogsListComponent implements OnInit/*, OnActivate*/ {
  ...
  ngOnInit() {
    ...
    const params = this._worklogService.getReportParams();
    console.log(params);
